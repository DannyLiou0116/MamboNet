...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
    ...
    print("Using {} scans from sequences {}".format(len(self.scan_files),
                                                    self.sequences))
    # print("self.scan_files.shape {}".format(self.scan_files))
...
class Parser():
  ...
  """def get_bin_info (self, index):
    self.SemanticKitti()
    _, _, _, _, _, _, _, _, _, _, proj_xyz, _, proj_remission, _, _ = SemanticKitti.__getitem__(self, index)
    print("proj_xyz.shape: ", proj_xyz.shape)
    print("proj_xyz.shape: ", proj_remission.shape)
    return proj_xyz, proj_remission"""
